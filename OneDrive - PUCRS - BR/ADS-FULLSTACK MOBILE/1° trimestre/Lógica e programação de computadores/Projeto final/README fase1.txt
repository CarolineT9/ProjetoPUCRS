##Instruçõs para contrução do Projeto:
...
• Temperatura máxima do mês: devem estar em Celsius, garanta que estejam dentro de um intervalo válido para temperaturas, tal como: -90 graus à +60 graus.
...
• Quantidade de meses escaldantes: quantidade de meses com acima de 40 graus Celsius.
